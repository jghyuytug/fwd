...
// Initial currency variables for new users
$regdb = 100000;  // Initial Cera (点券)
$regdd = 10000;   // Initial Cera Point (代币券)
...
function dnf_regedit($post_data){
	global $regdb, $regdd;  // Access global currency variables
	dnf_verification($post_data, 4);
	$username = $post_data[1];
	$password = $post_data[2];
	$qq = $post_data[3];
