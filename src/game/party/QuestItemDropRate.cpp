#include <party/QuestItemDropRate.h>
#include <game/party/QuestItemDropRate.h>

char __cdecl QuickParty::QuestItemDropRate::process(int id, CUser **a2, int value, int count)
{
  int id; // eax
  int id; // eax
  int id; // ebx
  ...
  if ( !(_BYTE)v4 )
  {
    ...
    if ( v4 >= 0 )
    {
      ...
      if ( v12 < v11 )
      {
        ...
        *(_DWORD *)(a4 + 24) = (int)((long double)*(int *)(a4 + 24) * v13);
        LOBYTE(v4) = a4;
      }
    }
  }
