...
int MemberPlayInfo20130502_Add(DBConnectionManager* manager, const MemberPlayInfo20130502* info) {
    ...
    snprintf(query, sizeof(query),
        "INSERT INTO member_play_info_20130502 "
...
int MemberPlayInfo20130502_Get(DBConnectionManager* manager, const char* occ_date, int m_id,
    ...
    snprintf(query, sizeof(query),
        ...
        "ip, last_play_time, pcbang_flag, end_ip, ting_count, mac_addr, server_id "
        "FROM member_play_info_20130502 WHERE occ_date = '%s' AND m_id = %d",
        occ_date, m_id);
...
int MemberPlayInfo20130502_Update(DBConnectionManager* manager, const MemberPlayInfo20130502* info) {
    ...
    snprintf(query, sizeof(query),
        "UPDATE member_play_info_20130502 SET "
...
int MemberPlayInfo20130502_Delete(DBConnectionManager* manager, const char* occ_date, int m_id) {
    ...
    snprintf(query, sizeof(query),
        "DELETE FROM member_play_info_20130502 WHERE occ_date = '%s' AND m_id = %d",
        occ_date, m_id);
...
int MemberPlayInfo20130502_Exists(DBConnectionManager* manager, const char* occ_date, int m_id) {
    ...
    snprintf(query, sizeof(query),
        "SELECT COUNT(*) FROM member_play_info_20130502 WHERE occ_date = '%s' AND m_id = %d",
        occ_date, m_id);
...
int MemberPlayInfo20130502_GetByMemberId(DBConnectionManager* manager, int m_id,
    ...
    snprintf(query, sizeof(query),
        "SELECT occ_date, m_id, play_time, play_count, trade_cnt, exp, used_fatigue, "
        "ip, last_play_time, pcbang_flag, end_ip, ting_count, mac_addr, server_id "
        "FROM member_play_info_20130502 WHERE m_id = %d ORDER BY occ_date DESC",
        m_id);
    ...
    while (count < max_count && DBQueryResult_FetchRow(&result, row) > 0) {
        memset(&infos[count], 0, sizeof(MemberPlayInfo20130502));
...
int MemberPlayInfo20130502_GetByDateRange(DBConnectionManager* manager, const char* start_date,
    ...
    snprintf(query, sizeof(query),
        "SELECT occ_date, m_id, play_time, play_count, trade_cnt, exp, used_fatigue, "
        "ip, last_play_time, pcbang_flag, end_ip, ting_count, mac_addr, server_id "
        "FROM member_play_info_20130502 WHERE occ_date >= '%s' AND occ_date <= '%s' "
...
int MemberPlayInfo20130502_GetByServer(DBConnectionManager* manager, unsigned char server_id,
    ...
    snprintf(query, sizeof(query),
        "SELECT occ_date, m_id, play_time, play_count, trade_cnt, exp, used_fatigue, "
        "ip, last_play_time, pcbang_flag, end_ip, ting_count, mac_addr, server_id "
        "FROM member_play_info_20130502 WHERE server_id = %u ORDER BY occ_date DESC",
        server_id);
...
int MemberPlayInfo20130502_GetPCBangUsers(DBConnectionManager* manager, const char* occ_date,
    ...
    snprintf(query, sizeof(query),
        "SELECT occ_date, m_id, play_time, play_count, trade_cnt, exp, used_fatigue, "
        "ip, last_play_time, pcbang_flag, end_ip, ting_count, mac_addr, server_id "
        "FROM member_play_info_20130502 WHERE occ_date = '%s' AND pcbang_flag = 1 "
        "ORDER BY m_id",
        occ_date);
...
void MemberPlayInfo20130502_PrintInfo(const MemberPlayInfo20130502* info) {
    ...
    printf("=== Member Play Info 20130502 ===\n");
    printf("Date: %s\n", info->occ_date);
    printf("Member ID: %d\n", info->m_id);
