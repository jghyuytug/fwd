...
int MemberMousepassHistory201604_Add(DBConnectionManager* manager, const MemberMousepassHistory201604* record) {
    ...
    snprintf(query, sizeof(query),
        "INSERT INTO member_mousepass_history_201604 "
...
int MemberMousepassHistory201604_Get(DBConnectionManager* manager,
    ...
    snprintf(query, sizeof(query),
        ...
        "FROM member_mousepass_history_201604 WHERE occ_time = '%s' AND m_id = %d",
        occ_time, m_id);
...
int MemberMousepassHistory201604_Delete(DBConnectionManager* manager,
    ...
    snprintf(query, sizeof(query),
        "DELETE FROM member_mousepass_history_201604 WHERE occ_time = '%s' AND m_id = %d",
        occ_time, m_id);
...
int MemberMousepassHistory201604_Exists(DBConnectionManager* manager,
    ...
    snprintf(query, sizeof(query),
        "SELECT COUNT(*) FROM member_mousepass_history_201604 "
...
int MemberMousepassHistory201604_GetByMemberId(DBConnectionManager* manager, int m_id,
    ...
    snprintf(query, sizeof(query),
        "SELECT occ_time, m_id, pre_mousepass, modify_type, ip_info, port_info "
        "FROM member_mousepass_history_201604 WHERE m_id = %d ORDER BY occ_time DESC",
        m_id);
    ...
    while (count < max_count && DBQueryResult_FetchRow(&result, row) > 0) {
        memset(&records[count], 0, sizeof(MemberMousepassHistory201604));
...
int MemberMousepassHistory201604_GetByIP(DBConnectionManager* manager, const char* ip_info,
    ...
    snprintf(query, sizeof(query),
        "SELECT occ_time, m_id, pre_mousepass, modify_type, ip_info, port_info "
        "FROM member_mousepass_history_201604 WHERE ip_info = '%s' ORDER BY occ_time DESC",
        ip_info);
...
int MemberMousepassHistory201604_GetByTimeRange(DBConnectionManager* manager,
    ...
    snprintf(query, sizeof(query),
        "SELECT occ_time, m_id, pre_mousepass, modify_type, ip_info, port_info "
        "FROM member_mousepass_history_201604 "
...
void MemberMousepassHistory201604_PrintInfo(const MemberMousepassHistory201604* record) {
    ...
    printf("Mouse Password History 201604:\n");
    printf("  occ_time: %s\n", record->occ_time);
    printf("  m_id: %d\n", record->m_id);
