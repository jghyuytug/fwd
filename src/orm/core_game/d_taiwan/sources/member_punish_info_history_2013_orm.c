...
int MemberPunishInfoHistory2013_Add(DBConnectionManager* manager,
    ...
    snprintf(query, sizeof(query),
        "INSERT INTO member_punish_info_history_2013 "
...
int MemberPunishInfoHistory2013_Get(DBConnectionManager* manager,
    ...
    snprintf(query, sizeof(query),
        ...
        "start_time, end_time, admin_id, reason, is_kicked, first_ssn, second_ssn "
        "FROM member_punish_info_history_2013 WHERE no = %d", no);
...
int MemberPunishInfoHistory2013_Update(DBConnectionManager* manager,
    ...
    offset = snprintf(query, sizeof(query),
        "UPDATE member_punish_info_history_2013 SET "
...
int MemberPunishInfoHistory2013_Delete(DBConnectionManager* manager, int no) {
    ...
    snprintf(query, sizeof(query),
        "DELETE FROM member_punish_info_history_2013 WHERE no = %d", no);
...
int MemberPunishInfoHistory2013_GetByMId(DBConnectionManager* manager,
    ...
    snprintf(query, sizeof(query),
        "SELECT no, m_id, punish_type, occ_time, punish_value, apply_flag, "
        "start_time, end_time, admin_id, reason, is_kicked, first_ssn, second_ssn "
        "FROM member_punish_info_history_2013 WHERE m_id = %d ORDER BY no DESC", m_id);
...
int MemberPunishInfoHistory2013_GetByTimeRange(DBConnectionManager* manager,
    ...
    snprintf(query, sizeof(query),
        "SELECT no, m_id, punish_type, occ_time, punish_value, apply_flag, "
        "start_time, end_time, admin_id, reason, is_kicked, first_ssn, second_ssn "
        "FROM member_punish_info_history_2013 "
...
int MemberPunishInfoHistory2013_GetByPunishType(DBConnectionManager* manager,
    ...
    snprintf(query, sizeof(query),
        "SELECT no, m_id, punish_type, occ_time, punish_value, apply_flag, "
        "start_time, end_time, admin_id, reason, is_kicked, first_ssn, second_ssn "
        "FROM member_punish_info_history_2013 WHERE punish_type = %d ORDER BY no DESC",
        punish_type);
...
int MemberPunishInfoHistory2013_CountByMId(DBConnectionManager* manager, int m_id) {
    ...
    snprintf(query, sizeof(query),
        "SELECT COUNT(*) FROM member_punish_info_history_2013 WHERE m_id = %d", m_id);
...
int MemberPunishInfoHistory2013_UpdateApplyFlag(DBConnectionManager* manager,
    ...
    snprintf(query, sizeof(query),
        "UPDATE member_punish_info_history_2013 SET apply_flag = %d WHERE no = %d",
        apply_flag, no);
...
void MemberPunishInfoHistory2013_PrintInfo(const MemberPunishInfoHistory2013* record) {
    ...
    printf("Member Punish Info History 2013:\n");
    printf("  No: %d\n", record->no);
    printf("  Member ID: %d\n", record->m_id);
