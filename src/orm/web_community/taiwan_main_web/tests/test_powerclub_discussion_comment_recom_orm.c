...
int main(int argc, char* argv[]) {
    ...
    printf("=== powerclub_discussion_comment_recom ORM Test ===\n\n");
...
void test_basic_crud(DBConnectionManager* manager) {
    ...
    PowerclubDiscussionCommentRecom records[10];
    int count = 0;

    if (PowerclubDiscussionCommentRecom_GetAll(manager, records, 10, &count) == 0) {
