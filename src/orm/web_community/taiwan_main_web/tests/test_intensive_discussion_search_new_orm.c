...
int main(int argc, char* argv[]) {
    ...
    printf("=== intensive_discussion_search_new ORM Test ===\n\n");
...
void test_basic_crud(DBConnectionManager* manager) {
    ...
    IntensiveDiscussionSearchNew records[10];
    int count = 0;

    if (IntensiveDiscussionSearchNew_GetAll(manager, records, 10, &count) == 0) {
