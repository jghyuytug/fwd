...
int AuctionHistoryBuyer201603_Add(DBConnectionManager* manager, const AuctionHistoryBuyer201603* record) {
    ...
    snprintf(query, sizeof(query),
        "INSERT INTO auction_history_buyer_201603 (auction_id, occ_time, pre_buyer_id, buyer_id, pre_price, price, pre_buyer_postal_id) "
...
int AuctionHistoryBuyer201603_GetAll(DBConnectionManager* manager, AuctionHistoryBuyer201603* records, int max_count, int* actual_count) {
    ...
    snprintf(query, sizeof(query),
        "SELECT auction_id, occ_time, pre_buyer_id, buyer_id, pre_price, price, pre_buyer_postal_id FROM auction_history_buyer_201603");
