...
/* Aggro entry for multi-target threat system (Phase 16 P2) */
typedef struct {
    uint32_t player_id;
    int32_t  aggro_value;
...
typedef struct {
    ...
    uint16_t spawn_x;
    uint16_t spawn_y;
    uint32_t target_player;           /* Current primary target (highest aggro) */
    /* Phase 16 P2: Multi-target aggro system */
    AggroEntry aggro_list[MAX_AGGRO_TARGETS];
    uint8_t  aggro_count;
...
typedef enum {
    ...
    BUFF_MAGIC_DEF_UP = 4,
    BUFF_SPEED_UP = 5,
    BUFF_ATTACK_SPEED_UP = 6,
    BUFF_CRIT_UP = 7,
    BUFF_HP_REGEN = 8,
    BUFF_MP_REGEN = 9,
    BUFF_ALL_STATS_UP = 10,
    BUFF_INVINCIBLE = 11,
    BUFF_SUPER_ARMOR = 12,
    DEBUFF_ATTACK_DOWN = 50,
    DEBUFF_DEFENSE_DOWN = 51,
    DEBUFF_SPEED_DOWN = 52,
    DEBUFF_POISON = 53,
    DEBUFF_BURN = 54,
    DEBUFF_FREEZE = 55,
    DEBUFF_STUN = 56,
    ...
    BUFF_LIFESTEAL = 101,
    BUFF_REFLECT = 102,
    BUFF_ELEMENTAL_FIRE = 103,
    BUFF_ELEMENTAL_ICE = 104,
    BUFF_ELEMENTAL_LIGHT = 105,
    BUFF_ELEMENTAL_DARK = 106,
    BUFF_DAMAGE_UP = 107,
    BUFF_BERSERK = 108,
    BUFF_REGEN = 109,
    BUFF_HEAL_OVER_TIME = 110,
    BUFF_EXP_BOOST = 111,
    BUFF_DROP_BOOST = 112,
    BUFF_TYPE_MAX
} BuffType;
...
#endif
#ifndef ELEMENT_LIGHT
#define ELEMENT_LIGHT 3
#endif
#ifndef ELEMENT_DARK
#define ELEMENT_DARK 4
#endif
