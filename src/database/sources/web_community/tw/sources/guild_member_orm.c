...
int GuildMember_Add(DBConnectionManager* manager, const GuildMember* record) {
    ...
    snprintf(query, sizeof(query),
        "INSERT INTO guild_member (guild_id, m_id, server_id, charac_no, charac_name, nick_name, grade, job, grow_type, lev, age, born_year, sex, apply_time, member_time, member_flag, bbs_cnt, last_visit_time, secede_type, secede_time, member_point, member_point_prev, last_play_time) "
        "VALUES (%d, %d, %d, %d, '%s', '%s', %d, %d, %d, %d, %d, '%s', '%s', '%s', '%s', %d, %d, '%s', %d, '%s', %d, %d, '%s')",
        record->guild_id, record->m_id, record->server_id, record->charac_no, record->charac_name, record->nick_name, record->grade, record->job, record->grow_type, record->lev, record->age, record->born_year, record->sex, record->apply_time, record->member_time, record->member_flag, record->bbs_cnt, record->last_visit_time, record->secede_type, record->secede_time, record->member_point, record->member_point_prev, record->last_play_time);
...
int GuildMember_Get(DBConnectionManager* manager, int guild_id, int charac_no, GuildMember* record) {
    ...
    snprintf(query, sizeof(query),
        "SELECT guild_id, m_id, server_id, charac_no, charac_name, nick_name, grade, job, grow_type, lev, age, born_year, sex, apply_time, member_time, member_flag, bbs_cnt, last_visit_time, secede_type, secede_time, member_point, member_point_prev, last_play_time FROM guild_member WHERE guild_id = %d AND charac_no = %d",
        guild_id, charac_no);
...
int GuildMember_GetAll(DBConnectionManager* manager, GuildMember* records, int max_count, int* actual_count) {
    ...
    snprintf(query, sizeof(query),
        "SELECT guild_id, m_id, server_id, charac_no, charac_name, nick_name, grade, job, grow_type, lev, age, born_year, sex, apply_time, member_time, member_flag, bbs_cnt, last_visit_time, secede_type, secede_time, member_point, member_point_prev, last_play_time FROM guild_member");
