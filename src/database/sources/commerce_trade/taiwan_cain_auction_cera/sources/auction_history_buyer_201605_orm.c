...
int AuctionHistoryBuyer201605_Add(DBConnectionManager* manager, const AuctionHistoryBuyer201605* record) {
    ...
    snprintf(query, sizeof(query),
        "INSERT INTO auction_history_buyer_201605 (auction_id, occ_time, pre_buyer_id, buyer_id, pre_price, price, pre_buyer_postal_id, commission) "
...
int AuctionHistoryBuyer201605_GetAll(DBConnectionManager* manager, AuctionHistoryBuyer201605* records, int max_count, int* actual_count) {
    ...
    snprintf(query, sizeof(query),
        "SELECT auction_id, occ_time, pre_buyer_id, buyer_id, pre_price, price, pre_buyer_postal_id, commission FROM auction_history_buyer_201605");
