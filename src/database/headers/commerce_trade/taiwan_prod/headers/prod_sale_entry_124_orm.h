#ifndef PROD_SALE_ENTRY_124_ORM_H
#define PROD_SALE_ENTRY_124_ORM_H
...
int ProdSaleEntry124_Update(DBConnectionManager* manager, const ProdSaleEntry124* record);
int ProdSaleEntry124_Delete(DBConnectionManager* manager, const char* agency_no);
int ProdSaleEntry124_Exists(DBConnectionManager* manager, const char* agency_no);
int ProdSaleEntry124_GetAll(DBConnectionManager* manager, ProdSaleEntry124* records, int max_count, int* actual_count);

#endif /* PROD_SALE_ENTRY_124_ORM_H */