...
// MSVC-style integer types for compatibility
...
// Calling convention macros for MSVC/IDA compatibility
#ifndef __cdecl
#define __cdecl  /* GCC doesn't use cdecl, this is for compatibility */
#endif
