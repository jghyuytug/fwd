...
#include <stdint.h>
#include <stdbool.h>
#include "common/defs.h"  // Use common type definitions
...
extern int __cdecl MySQL_get_ubyte(MySQL *pthis, int id, uint8_t *a3);
extern int __cdecl MySQL_get_ushort(MySQL *pthis, int id, uint16_t *a3);
extern int __cdecl MySQL_get_ulong(MySQL *pthis, int id, unsigned int *a3);
extern int __cdecl MySQL_get_ulonglong(MySQL *pthis, int id, uint64_t *a3);
