...
def main():
    print("=" * 60)
    print("Key Expansion V4")
    print("Target: 30% -> 35%+ (691 -> 805+ keys)")
    print("=" * 60)
    ...
    # Save to file (avoid encoding issues)
    output_file = 'key_expansion_v7.py'
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write("#!/usr/bin/env python3\n")
        f.write('"""键映射扩展V7 - 目标35%+"""\n\n')
        f.write("# V7 Keys - 150 new keys\n")
        f.write("V7_KEYS = {\n")
    ...
    # Also print first 30 for quick verification
    print("\n# First 30 V7 keys:")
    count = 0
    for key in sorted(new_mappings.keys()):
        if count >= 30:
