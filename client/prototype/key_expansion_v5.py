...
def analyze_remaining(pvf: PVFReader, st: PVFStringTable, sample_size: int = 120000):
    """分析剩余未映射的键"""
...
def main():
    print("=" * 60)
    print("Key Expansion V5")
    print("Target: 36.6% -> 40%+ (841 -> 920+ keys)")
    print("=" * 60)
    ...
    key_stats = analyze_remaining(pvf, st, sample_size=120000)
    ...
    # Save to file
    output_file = 'key_expansion_v8.py'
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write("#!/usr/bin/env python3\n")
        f.write('"""键映射扩展V8 - 目标40%+"""\n\n')
        f.write("# V8 Keys - 100 new keys\n")
        f.write("V8_KEYS = {\n")
