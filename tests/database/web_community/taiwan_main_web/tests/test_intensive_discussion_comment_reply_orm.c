...
int main(int argc, char* argv[]) {
    ...
    printf("=== intensive_discussion_comment_reply ORM Test ===\n\n");
...
void test_basic_crud(DBConnectionManager* manager) {
    ...
    IntensiveDiscussionCommentReply records[10];
    int count = 0;

    if (IntensiveDiscussionCommentReply_GetAll(manager, records, 10, &count) == 0) {
