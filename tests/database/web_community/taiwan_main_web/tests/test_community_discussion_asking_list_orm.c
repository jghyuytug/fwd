...
int main(int argc, char* argv[]) {
    ...
    printf("=== community_discussion_asking_list ORM Test ===\n\n");
...
void test_basic_crud(DBConnectionManager* manager) {
    ...
    CommunityDiscussionAskingList records[10];
    int count = 0;

    if (CommunityDiscussionAskingList_GetAll(manager, records, 10, &count) == 0) {
