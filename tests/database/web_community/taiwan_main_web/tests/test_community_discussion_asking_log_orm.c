...
int main(int argc, char* argv[]) {
    ...
    printf("=== community_discussion_asking_log ORM Test ===\n\n");
...
void test_basic_crud(DBConnectionManager* manager) {
    ...
    CommunityDiscussionAskingLog records[10];
    int count = 0;

    if (CommunityDiscussionAskingLog_GetAll(manager, records, 10, &count) == 0) {
