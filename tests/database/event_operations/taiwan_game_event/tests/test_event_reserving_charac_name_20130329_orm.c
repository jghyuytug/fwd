...
int main(int argc, char* argv[]) {
    ...
    printf("=== event_reserving_charac_name_20130329 ORM Test ===\n\n");
...
void test_basic_crud(DBConnectionManager* manager) {
    ...
    EventReservingCharacName20130329 records[10];
    int count = 0;

    if (EventReservingCharacName20130329_GetAll(manager, records, 10, &count) == 0) {
